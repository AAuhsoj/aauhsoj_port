...
function watchScripts() {
  ...
  gulp.watch([ '_js/side-projects-modal.js' ], sideProjectsModal);
}
...
var compile = gulp.parallel(styles, stylesVendors, scripts, scriptsVendors, sideProjectsModal);
 ...
 */
gulp.task('build', gulp.series(compile, jekyll));
